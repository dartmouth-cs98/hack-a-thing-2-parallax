...
extern "C" IL2CPP_METHOD_ATTR int32_t Device_get_generation_m794015809 (RuntimeObject * __this /* static, unused */, const RuntimeMethod* method)
{
	typedef int32_t (*Device_get_generation_m794015809_ftn) ();
	static Device_get_generation_m794015809_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (Device_get_generation_m794015809_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.iOS.Device::get_generation()");
	int32_t retVal = _il2cpp_icall_func();
	return retVal;
}
#ifdef __clang__
